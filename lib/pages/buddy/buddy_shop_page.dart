            ...
            Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    // 씨앗키트 상품 목록 (3x6 그리드) - 반응형 열 간격, 고정 행 간격
                    LayoutBuilder(
                      builder: (context, constraints) {
                        final List<Map<String, String>> products = getProductList();
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          // 영양제 상품 목록 (3x1 그리드) - 반응형 열 간격, 고정 행 간격
                          LayoutBuilder(
                            builder: (context, constraints) {
                              final List<Map<String, String>> products = getNutritionList();
                              final int cardsPerRow = 3;
                              final double cardWidth = 100;
                              final double totalCardWidth = cardWidth * cardsPerRow;
                              final double totalSpacing = constraints.maxWidth - totalCardWidth;
                              ...
                              for (int i = 0; i < products.length; i += cardsPerRow) {
                                ...
                                for (int j = 0; j < cardsPerRow; j++) {
                                  ...
                                  if (index >= products.length) {
                                    ...
                                    final product = products[index];
                                    rowCards.add(_buildNutritionCard(
                                      imagePath: product['image']!,
                                      productName: product['name']!,
                                    ));
                                  }
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          LayoutBuilder(
                            builder: (context, constraints) {
                              final List<Map<String, String>> products = getDecorationList();
                              final int cardsPerRow = 3;
                              final double cardWidth = 100;
                              final double totalCardWidth = cardWidth * cardsPerRow;
                              final double totalSpacing = constraints.maxWidth - totalCardWidth;
                              ...
                              for (int i = 0; i < products.length; i += cardsPerRow) {
                                ...
                                for (int j = 0; j < cardsPerRow; j++) {
                                  ...
                                  if (index >= products.length) {
                                    ...
                                    final product = products[index];
                                    rowCards.add(_buildDecorationCard(
                                      imagePath: product['image']!,
                                      productName: product['name']!,
                                    ));
                                  }
